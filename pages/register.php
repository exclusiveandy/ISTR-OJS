      ...
      <div class="container">
         <div class="row mb-2">
            <div class="col-sm-6" style="padding-bottom: 2%; padding-top: 2%;">
               <h1 class="m-0 text-dark" style="font-size: 20pt; ">Register</h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6" style="padding-bottom: 2%; padding-top: 2%;">
                  ...
                  <div class="card card-info">
                     ...
                     <form role="form">
                        <div class="card-body">
                           ...
                           <div class="form-group">
                              <label for="exampleInputPassword1" style="font-weight:500;">Password</label>
                              <input type="password" class="form-control" id="password" name="password" placeholder="Password">
                              <span id="error_password" class="text-danger"></span>
                           </div>
                           <div class="form-group">
                              <label for="exampleInputPassword1" style="font-weight:500;">Confirm Password</label>
                        ...
                        <!-- /.card-body -->
                           ...
                           <button style="width: 100%;" type="submit" class="btn btn-success" name="submit" id="submit">Submit</button>
...
<!-- /.content-wrapper -->
<?php include "pagecomponents/mainfooter.php";?>
