              ...
              <form role="addjournal.php" method="POST" enctype="multipart/form-data" id="form" name="form">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="Print_issn" name="Print_issn"  placeholder="Enter Print ISSN">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="Online_issn" name="Online_issn" placeholder="Enter Online ISSN">
