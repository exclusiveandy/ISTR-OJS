...
?>
 ...
 <?php 
    $journal_count_query = query("SELECT COUNT(journal_id) as count
     FROM `journal_table`as j ");
      $row_count = fetch_assoc($journal_count_query);
     ?>
      ...
      <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="journal.php" class="small-box-footer">
          ...
          <?php
          $for_publishing_query = query("SELECT COUNT(user_id) as count
     FROM `user_table`as r 
     where user_role_id = 1 and activate = 1");
           $row_publishing_count = fetch_assoc($for_publishing_query);
          ?>
          <div class="col-lg-3 col-6">
            <!-- small card -->
            <div class="small-box bg-successs">
              <div class="inner">
                <h3> <?php
                    if($row_publishing_count['count'] != 0)
                    {
                    ?>
                ...
                <p>Lists of Authors</p>
              </div>
              <div class="icon">
                   <i class="nav-icon fas fa-users"></i>
              </div>
              <a href="list_of_authors.php" class="small-box-footer">
                More info <i class="fas fa-arrow-circle-right"></i>
              </a>
            </div>
          </div>
          ...
          <?php
 $volume_query = query("SELECT COUNT(user_Id) as count from apply_reviewer_table where status ='0' ");
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                  ...
                  ?></h3>
                <p>Applicants for Reviewer</p>
              </div>
              <div class="icon">
                 <i class="nav-icon fas fa-users"></i>
              </div>
              <a href="list_of_applicants_reviewers.php" class="small-box-footer">
                More info <i class="fas fa-arrow-circle-right"></i>
              </a>
            </div>
          </div>
...
<?php
 $published_volume_query = query("SELECT COUNT(user_id) as count from user_table where user_role_id in(2,3,4,5,6,7,8)");
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-light">
              <div class="inner">
                  ...
                  ?></h3><p>Lists of Reviewers/Editors</p>
              </div>
              <div class="icon">
                 <i class="nav-icon fas fa-users"></i>
              </div>
              <a href="officials.php" class="small-box-footer">
                More info <i class="fas fa-arrow-circle-right"></i>
              </a>
            </div>
          </div>
