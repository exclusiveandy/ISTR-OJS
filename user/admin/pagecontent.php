...
<?php include "header.php";?>
    ...
    <section class="content">
                ...
                if(row_count($url_content) != 0)
                {
                  ...
                  <div class="card card-outline card-danger">
                    <div class="card-header">
                      ...
                      <button type="button" data-toggle="modal" data-target="#add_home_page_modal" data-uid="1" class="btn btn-secondary btn-md add_home_page_picture" style="float: right;" >Add a New Home Page Picture</button>
                    </div>
                      <div class="card-body" id="home_page_picture_table">
                        ...
                        ?>
                                  ...
                                  <tr>
                                      ...
                                      <td><img src="<?php echo $row['location'];?>" alt="ojslogo" id="about_ojs_picture" width="500px" height="150px"></td>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" id="header_url">Add Url</h4>
     ...
     <div class="modal fade" id="add_section_about_us">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" id="header_about">Add Section in About US</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
      ...
      <div class="modal fade" id="delete_section_about_us">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" id="header_about">Delete Section in About US</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
      ...
      <div class="modal fade" id="add_downloadble_modal">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" id="header_downloadble">Add Downloadable</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
  ...
  <div class="modal fade" id="delete_downloadble_modal">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Delete Downloadble</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
...
<div class="modal fade" id="add_home_page_modal">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" id="header_home_page">Add Home Page Picture</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            ...
            <span aria-hidden="true">&times;</span>
                ...
                <div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                        <img src="../../images/placeholder.png" onclick="triggerClick2()" alt="ojslogo" id="home_page_picture_preview" width="450px" height="150px">
                  </div> 
            ...
            <span aria-hidden="true">&times;</span>
                ...
                <div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                        <img src="../../images/placeholder.png" alt="ojslogo" id="delete_home_page_picture_preview" width="450px" height="150px">
                  </div> 
  ...
  $(document).on('click', '.edit_about_ojs', function(){
    ...
    $.ajax({
      ...
      success:function(data){
          ...
          $("#header_about").text("Edit Title and Description in About");
...
$(document).on('click', '.edit_downloadble', function(){
    ...
    $.ajax({
      ...
      success:function(data){
          ...
          $("#header_downloadble").html("Edit downloadble");
          $("#insert_downloadble").attr("hidden", "true")
      ...
      success:function(data){
          $("#home_page_picture_preview").attr("src", data.location);
           ...
           $("#insert_home_page_picture").val("Update Picture in Home Page");
            $("#header_home_page").text("Update Picture in Home Page");
