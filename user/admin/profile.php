  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><?php $_SESSION['role_name'] =$row['user_role_name']; 
            echo $row['user_role_name'];?></h1>
          </div>
          <div class="col-sm-6">
                  ...
                  <div class="card-body box-profile">
                    ...
                    <ul class="list-group list-group-unbordered mb-3">
                      <li class="list-group-item">
                        <b>Published</b> <a class="float-right">13</a>
                      </li>
                      <li class="list-group-item">
                        <b>Reviewed</b> <a class="float-right">120</a>
                      </li>
                    </ul>
...
$(document).ready(function()
{
  $("#update").click(function(event){
      ...
      if($.trim($('#fname').val()) == 0 )
        ...
        if($.trim($('#mname').val()) == 0 )
        {
         error_mname = 'Please enter your Middle Name';
            $('#error_mname').text(error_mname);
         $('#mname').css("border-color", "#cc0000")
          $('#mname').css("background-color", "#ffff99")
        }
        else
        {
           error_mname = '';
            $('#error_mname').text(error_mname);
          $('#mname').css("border-color", "#ccc")
        ...
        if(error_lname == '' &&  error_fname == '' && error_mname == '' && error_salu == '' && error_contact == '' && error_affliation == '' && error_biostatement == '' && error_mailaddress == '')
  {
        var fname = $("#fname").val();
          var mname = $("#mname").val();
          var lname = $("#lname").val();
