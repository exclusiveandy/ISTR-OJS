          ...
          <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" rows="3" id="Comment" placeholder="Enter ...">Rejected by Editor in Chief</textarea>
                  </div>
          
            <a href="reject.php?r_id=<?php echo $_GET['r_id'];?>"class="btn btn-block btn-danger" id="rejected">Rejected As It Is</a>
            <a href="accept.php?r_id=<?php echo $_GET['r_id'];?>" class="btn btn-block btn-success" id="accepted">Accepted As It Is</a>
      ...
      if($("#chckbox_scope").is(':checked'))
       {
        ...
        $("#Comment").val('Accepted the document by Editor in Chief');
       ...
       else
       {
         ...
         $("#Comment").val('Rejected by Editor in Chief');
      ...
      if($("#chckbox_scope").is(':checked'))
       {
        ...
        $("#Comment").val('');
        $("#accepted").removeAttr("hidden", "false");
        $("#Comment").val('Accepted the document Editor in Chief');
        // $("#Appraisal").attr("hidden", "true");
        // $('#hello td').remove();
       }
       else
