...
$data_number_rejected_year = trim($data_number_rejected_year, ",");
  ...
  $query_rejected_ME = query("SELECT COUNT(r.research_id) as count
from research_table r
where r.research_id 
IN
(SELECT r.research_id from research_file_history_table r
...
$query_rejected_EIC = query("
  SELECT COUNT(r.research_id) as count
from research_table r
where r.research_id 
IN
(SELECT r.research_id  from research_file_history_table r
...
$query_rejected_IR = query("  SELECT COUNT(r.research_id) as count
from research_table r
where r.research_id 
IN
(SELECT count(r.research_id) as count from research_file_history_table r
join research_table r2
on r2.research_id=r.research_id
where r2.user_id =  '{$user_id}' and r2.status = \"Rejected\" and r2.user_role_id = '1'
group by r.research_id
