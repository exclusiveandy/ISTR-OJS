...
?>
      ...
      <div class="modal-header">
              <h4 class="modal-title">Assign an External Reviewer</h4>
            ...
            <div class="modal-body">
                  ...
                  <div class="form-group">
                    <label>External Reviewers</label>

                    <select class="form-control" name="USER">
                    <?php 
                        display_external_reviewer();
                    ?>
                    </select>
                  </div>
      ...
      ?>
      <div class="modal-header">
              <h4 class="modal-title">Send to the Assigned External Reviewer</h4>
            ...
            <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="USER">
                    <?php 
                        display_assigned_external_reviewer();
                    ?>
                    </select>
                  </div>
    ...
    else
    {
     ...
     $date = date("Y-m-d H:i:s");
      ...
      if(row_count($chk_external_reviewer) == 0)
      {
          ...
          $date_expired;
          $sql =  query("INSERT INTO reviewer_table(user_id, research_id, date_uploaded, date_expired) VALUES ('{$u_id}','{$r_id}', '{$date}', '{$date_expired}')");
      }
      ...
      if(!empty($_POST['Comment']))
      {
        ...
        $sql1 = query("UPDATE research_table SET status = 'On External Reviewer', user_role_id = '5' where research_id = '{$r_id}' ");
        $insert_timeline = query("INSERT INTO timeline_table(document_id, Type, Remarks, timeline_date) VALUES ('{$r_id}', 'Reviewing', 'Being Processed by an External Reviewer', '{$date}')");        
     ...
     $user_ie = $row['user_id'];
      ...
      $insert_into = query("INSERT INTO notification(status, message, date, user_id, notification_type, research_id)
                    VALUES('unread', '{$message}', '{$date}', '{$user_ie}', 'review_er', '{$r_id}')");
      redirect("home.php");
      }
      ?>
