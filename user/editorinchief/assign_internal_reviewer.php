...
?>
      ...
      ?>
      <div class="modal-header">
              <h4 class="modal-title">Send to the Assigned Internal Reviewer</h4>
            ...
            <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="USER">
                    <?php 
                        display_assigned_internal_reviewer();
                    ?>
                    </select>
                  </div>
    ...
    else
    {
      ?>
       <div class="modal-header">
              <h4 class="modal-title">There is no currently Internal Reviewer for the journal. <br> Kindly contact the admin</h4>
            </div>
     <?php
     }
     ?> 
     ...
     $user_ie = $row['user_id'];
      ...
      $insert_into = query("INSERT INTO notification(status, message, date, user_id, notification_type, research_id)
                    VALUES('unread', '{$message}', '{$date}', '{$user_ie}', 'review_ie', '{$r_id}')");
      redirect("home.php");
      }
