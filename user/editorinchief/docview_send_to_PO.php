          ...
          <div class="card-body">
            ...
            <dl class="dl-horizontal">
              <?php if(isset($_GET['r_id']))
              {
                  ...
                  $query = query("SELECT r1.research_file, date_uploaded, r1.supplementary_file, r2.title, r2.abstract FROM research_file_table r1 join research_table r2 on r1.research_id=r2.research_id where r1.research_id = '{$research_id}' ORDER BY date_uploaded asc LIMIT 1");
                  confirm($query);
...
<?php
     ...
     <?php
      ...
      <div class="card-body">
            ...
            <button class="btn btn-block btn-success" id="send_to_PO" name="send_to_PO">Send it to the Publication Office</button>
               </form>
 ...
 $("#send_to_PO").click(function(e){
        ...
        e.preventDefault();
         ...
         if($.trim($("#Comment").val()) == "")
         {
          ...
          $("#send_to_PO").attr("hidden", "true");
          $("#loader").show();
     $("#loader").hide();
     $("#send_to_PO").removeAttr("hidden", "true");
