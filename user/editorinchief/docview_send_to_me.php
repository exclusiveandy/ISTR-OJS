          ...
          <div class="card-body">
            ...
            <dl class="dl-horizontal">
              <?php if(isset($_GET['r_id']))
              {
                  ...
                  $query = query("SELECT  r1.research_file, date_uploaded, r1.supplementary_file, r2.title, r2.abstract FROM research_file_table r1 join research_table r2 on r1.research_id=r2.research_id where r1.research_id = '{$research_id}' ORDER BY date_uploaded desc LIMIT 1");
                  confirm($query);
  ...
  <li class="nav-item">
    <a class="nav-link" href="#tab_8" data-toggle="tab">Supplementary File</a>
               ...
               <div class="tab-content">
                  ...
                  <?php if(!empty($row['supplementary_file']))
                    {
                        $sfilename = substr($row['supplementary_file'], 0, strpos($row['supplementary_file'], "."))
                    ?>
                     </div>
      ...
      <div class="card-body">
                ...
                <form method="POST">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" rows="5" id="Comment" name="Comment" placeholder="Enter ..."><?php $comment_query = query("SELECT * from comment_table where research_id = '{$id}'");
            ...
            <button class="btn btn-block btn-success" id="send_to_me" name="send_to_me">Send it to the Managing Editor</button>
               </form>
  ...
  $("#send_to_me").click(function(e){
        ...
        e.preventDefault();
         ...
         if($.trim($("#Comment").val()) == "")
         {
          ...
          $("#send_to_me").attr("hidden", "true");
          $("#loader").show();
     $("#loader").hide();
     $("#send_to_me").removeAttr("hidden", "true");
