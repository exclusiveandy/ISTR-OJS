...
redirect('../../pages/login.php');
  ...
  <div class="content-wrapper">
    ...
    <section class="content" style="overflow-y:visible; ">
     ...
     where user_role_id = '3' and r.journal_id='{$journal_id}' and(r.status = \"Issue of Volume\" or r.status = \"For Publication Office\" or r.status=\"Assigning of Volume and Issue\" OR r.status = \"To the Proofreader\" OR r.status = \"To the Layout Editor\") order by research_id asc");
    confirm($query);
    while($row = fetch_assoc($query))
    {
      ?>
              ...
              <td><?php echo $row['date_submitted']?></td>
                      <td>
           <a href="docview_send_to_PO.php?r_id=<?php echo $row['research_id']?>" class="btn btn-info btn-md" id="hello" style="margin-left: 20%;"><span class="fa fa-book"></span></a>
             </td>
              <td>
