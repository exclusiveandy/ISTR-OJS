...
redirect('../../pages/login.php');
  ...
  <div class="content-wrapper">
    ...
    <section class="content" style="overflow-y:visible; ">
     ...
     where user_role_id = '3' and r.journal_id='{$journal_id}' and r.status = \"Assign an External Reviewer\" order by research_id asc");
    confirm($query);
    while($row = fetch_assoc($query))
    {
      ?>
              ...
              <td><?php echo $row['date_submitted']?></td>
                      <td>
            <a href="assign_external_reviewer.php?r_id=<?php echo $row['research_id']?>" class="btn btn-info btn-md" style="margin-left: 20%;"><span class="fa fa-book"></span></a>
             </td>
              <td>
