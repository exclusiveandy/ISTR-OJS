    ...
    <section class="content" style="overflow-y:visible; ">
      ...
      <div class="card">
        ...
        <div class="card-body">
         ...
         join reviewer_table as r2 on r2.research_id=r.research_id
         where (user_role_id = '4' OR user_role_id = '5') and r.journal_id='{$journal_id}'");
    confirm($query);
   ...
   var research_id =  $("#r_id").val();
     ...
     success:function(data)
    {
      $("#modal_default").modal("hide");
        if($.trim(data) == "3")
        {
      $(window).attr('location', 'assign_internal_reviewer.php?r_id='+research_id);
        }
         if($.trim(data) == "")
        {
      $(window).attr('location', 'assign_external_reviewer.php?r_id='+research_id);
        }
    }
    })
    })
