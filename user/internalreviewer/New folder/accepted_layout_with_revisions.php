...
include "../../../function.php";
    ...
    $sql = query("UPDATE research_table SET status = 'To the Publication Office(Proofreader)', user_role_id = '2' where research_id = '{$id}'");
    ...
    $sql = query("UPDATE research_table SET status = 'To the Publication Office(Layout Editor)', user_role_id = '2' where research_id = '{$id}'");
        $insert_timeline = query("INSERT INTO timeline_table(document_id, Type, Remarks, timeline_date) VALUES ('{$id}', 'Revision', 'Not Accepted by the Author', '{$date}')");
    }
