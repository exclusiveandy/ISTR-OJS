  ...
  <div class="content-wrapper">
    ...
    <!-- /.FOR LOOP HERE -->
      ...
      <div class="card">
        ...
        <br>
        <ol>
                  Only manuscripts that fall within the focus and scope of the Journal will be considered.
...
This section should include the design of the study, the type of materials involved, a clear description of all comparisons, and the type of analysis used, to enable replication. For studies involving human participants, a statement detailing ethical approval and consent should be included.
...
References cited in the text should be presented according to the APA (American Psychological Association) Style Manual, latest edition. The list of References should be given at the end of the paper, immediately following the section on acknowledgement, if any.

In preparing illustration and figures, ensure that each figure includes a single illustration and should fit on a single page in portrait format. If a figure consists of separate parts, it is important that a single composite illustration file be submitted which contains all parts of the figure. The following file formats can be accepted: PDF, TIFF, PNG, JPEG or BMP.Note that it is the responsibility of the author(s) to obtain permission from the copyright holder to reproduce figures or tables that have previously been published elsewhere.

Proofs will be sent by email to the corresponding author and are expected to proofread the article carefully. The corrected proof should be received by the administration within two working days.

The PUPJST adheres to the following four criteria in authorship recommended by International Committee of Medical Journal Editors (ICMJE):
...
Agreement to be accountable for all aspects of the work in ensuring that questions related to the accuracy or integrity of any part of the work are appropriately investigated and resolved.
        ...
        <div class="card-footer">
          <button type="button" class="btn btn-primary">Download Author's Guide</button>
