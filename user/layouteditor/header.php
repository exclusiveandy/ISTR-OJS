              ...
              while($row = fetch_assoc($query))
              {
                ...
                <a href="calendar.php" class="dropdown-item">
                  ...
                  <?php
                   ...
                   else if($result['notification_type'] == "review_layout")
                {
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      $count_query = query("SELECT COUNT(p.research_id) as count from research_table as r
        join  layouteditor_table as p
        on p.research_id=r.research_id
        where p.user_id = '{$user}' AND r.user_role_id = '7'");
     ...
     ?>
          ...
          <li class="nav-item has-treeview ">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="layoutediting.php" class="nav-link">
