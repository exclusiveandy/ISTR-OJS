<?php include("usernav.php");?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <?php 
    $research_query = query("SELECT * from research_file_table where research_id = '{$_GET['r_id']}' ORDER BY date_uploaded asc");
...
<?php
     ...
     <?php
      ...
      <div class="card-body">
            ...
            <button class="btn btn-block btn-success" id="send_to_EIC" name="send_to_EIC">Send it to the Editor in Chief</button>
               </form>
 ...
 $("#send_to_EIC").click(function(e){
        ...
        e.preventDefault();
         ...
         if($.trim($("#Comment").val()) == "")
         {
          ...
          $("#send_to_EIC").attr("hidden", "true");
          $("#loader").show();
     $("#loader").hide();
     $("#send_to_EIC").removeAttr("hidden", "true");
