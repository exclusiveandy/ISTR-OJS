        ...
        <div class="card-body" style="max-height:200px;">
                   ...
                   <div class="form-group">
                    <div class="form-check" style="text-align: center;">                     
                      ...
                      <label class="form-check-label" style="font-size: 15px"><label>No changes in terms of Grammar  or <br>   No altered Words (Proofread)</label></label>
                    </div> 
                  </div>
     ...
     <?php
      ...
      <div class="card">
        ...
        <div class="card-body">
                  ...
                  <div id="revised_document">
                  <label>Upload the revised document</label>
...
<!--                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" rows="3" id="Comment" name="Comment" placeholder="Enter your remarks here for timeline">Please see the changes that i have been marked</textarea>
                  </div>
          
            
                <button class="btn btn-block btn-success" id="accepted_with_revisions" name="accepted_with_revisions" >Accepted with Revision</button>
            <div id="loader" style="display: none; text-align: center;">
            <img src="../../images/loading3.gif" width="50px" height="50px">
            </div>
           <button class="btn btn-block btn-success" id="accepted" name="accepted" hidden>Send to the Publication Office</button>
                </form>
           <?php 
