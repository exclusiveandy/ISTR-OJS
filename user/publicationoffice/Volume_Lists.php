        ...
        <div class="card">
                    ...
                    <table id="example2" class="table table-bordered table-hover">
                       ...
                       <?php
                        ...
                        $volume_query = query("SELECT journal_name, v.journal_id, v.volume_id, volume, issue, DATE_FORMAT(date_open, \"%M, %d, %Y\") as date_open from volume_table v join journal_table j on j.journal_id=v.journal_id where v.status ='0'");
