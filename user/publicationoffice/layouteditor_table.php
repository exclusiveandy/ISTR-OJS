...
redirect('../../pages/login.php');
  ...
  <div class="content-wrapper">
    ...
    <section class="content" style="overflow-y:visible; ">
     ...
     where user_role_id = '8' and (r.status = \"To the Layout Editor\") order by research_id asc");
    confirm($query);
    while($row = fetch_assoc($query))
    {
      ?>
              ...
              <td><?php echo $row['date_submitted']?></td>
                      <td>
        <a href="assign_layout_editor.php?r_id=<?php echo $row['research_id']?>" class="btn btn-info btn-md" style="margin-left: 20%;"><span class="fa fa-book"></span></a>
             </td>
              <td>
