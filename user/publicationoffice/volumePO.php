      ...
      <section class="content">
        <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Volume Lists (Journal: <?php echo $journal_name;?>)</h3>
                    </div>
                    <div class="card-body">
                    <table id="example2" class="table table-bordered table-hover">
                       ...
                       <?php
                        ...
                        $volume_query = query("SELECT v.volume_id, volume, issue, DATE_FORMAT(date_open, \"%M, %d, %Y\") as date_open from volume_table v where v.journal_id = '{$journal_id}' AND v.status = '0' ");
                        ...
                        <td>     
                        <button type="submit" id="<?php echo $row_volume['volume_id']?>" class="btn btn-success edit_data" onclick="window.location.href='assign_volume.php?r_id=<?php echo  $id;?>&v_id=<?php echo $row_volume['volume_id']?>'">Assign</button>
                        </td>
                        </tr>
                        <?php
                          }
